...
import com.minto.soft.moviesapp.ui.movieslist.MoviesActivity;
import com.minto.soft.moviesapp.ui.movieslist.MoviesFilterType;
import com.minto.soft.moviesapp.utils.Injection;
import com.minto.soft.moviesapp.utils.ItemOffsetDecoration;
import com.minto.soft.moviesapp.utils.UiUtils;
import com.minto.soft.moviesapp.utils.ViewModelFactory;
...
public class PopularMoviesFragment extends Fragment {
    ...
    public static PopularMoviesViewModel obtainViewModel(FragmentActivity activity) {
        ViewModelFactory factory = Injection.provideViewModelFactory(activity);
        return ViewModelProviders.of(activity, factory).get(PopularMoviesViewModel.class);
    }

    private void setupListAdapter() {
        RecyclerView recyclerView = getActivity().findViewById(R.id.rv_movie_list);
        final PopularMoviesAdapter popularMoviesAdapter =
                new PopularMoviesAdapter(viewModel);
        ...
        layoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                switch (popularMoviesAdapter.getItemViewType(position)) {
        ...
        viewModel.getNetworkState().observe(getViewLifecycleOwner(), new Observer<Resource>() {
            ...
            public void onChanged(Resource resource) {
                popularMoviesAdapter.setNetworkState(resource);
            }
        });
    }
}
